...
def main(PORT1, detector, resize, NUM_IMAGES):
    ...
    CROPw = 400   #SETTING FOR DEMO
    CROPh = 150   #SETTING FOR DEMO

    #CROPw = 200   #SETTING FOR FIG1
    #CROPw = 150   #SETTING FOR FIG1
    ...
    for i in range (0, NUM_IMAGES): 
        ...
        cv2.imwrite("./BlimpTest1/"+str(i)+".jpg", im_bgr)
        cv2.imshow("", im_bgr)
        cv2.waitKey(1)
...
resize = False
main(PORT, detector, resize, NUM_IMAGES)
